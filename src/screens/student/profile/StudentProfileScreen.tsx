        ...
        async (
          ...
          try {
            ...
            if (
              ...
              throw new Error(
                "Invalid student profile response"
              );
            }

            /*
             * Backend may return academic fields
             * directly on student or inside
        ...
        <SafeAreaView className="flex-1 items-center justify-center bg-[#F5F7FB] px-6">
          ...
          <View className="mt-6 w-full flex-row gap-3">
            ...
            >
              ...
              <Text className="font-bold text-[#D92D20]">
                Logout
              </Text>
            </Pressable>
          </View>
          ...
          <View className="-mt-14 px-5">
            <View className="rounded-3xl border border-[#E4E8F0] bg-white p-5 shadow-sm">
              <View className="flex-row items-center">
                ...
                <View className="ml-4 flex-1">
                  <Text
                    className="text-xl font-extrabold text-[#14213D]"
                    numberOfLines={
                      2
                    }
                  >
            ...
            <Pressable
              ...
              className={`mt-5 min-h-12 flex-row items-center justify-center gap-2 rounded-2xl border border-red-100 bg-red-50 px-4 ${
                loggingOut
                  ? "opacity-60"
                  : ""
              }`}
...
const Badge = ({
  ...
  return (
    <View className="flex-row items-center rounded-full bg-[#EEF1FF] px-2.5 py-1">
      ...
      <Text className="ml-1 text-xs font-bold text-[#3154D9]">
        {label}
      </Text>
    </View>
  );
...
const SummaryItem = ({
  ...
  return (
    <View className="min-w-0 flex-1 items-center">
      <Text className="text-[10px] font-bold uppercase tracking-wide text-[#98A2B3]">
        {label}
      </Text>
  ...
  return (
    <View className="mt-4 overflow-hidden rounded-2xl border border-[#E4E8F0] bg-white shadow-sm">
      <View className="flex-row items-center border-b border-[#EEF1F5] px-4 py-3.5">
        ...
        <Text className="ml-3 text-base font-extrabold text-[#14213D]">
          {title}
        </Text>
      </View>
  ...
  return (
    <View
      className={`${
        multiline
          ? "py-3.5"
          : "min-h-12 flex-row items-center py-2.5"
      } ${
        !last
